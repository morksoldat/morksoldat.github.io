const questions = {
	...
	"C": [
		...
		["Hongo que produce meningitis en pacientes infectados con VIH con inmunodepresión severa.", "crytococcus neoformans"],
	...
	"D": [
		...
		["Infección por arbovirus que causa fiebre, mialgias y trombocitopenia.", "difteria"]
	],
	"E": [
	...
	"F": [
		...
		["Hongo filamentoso ampliamente distribuido en el suelo y plantas que puede causar infecciones localizadas como queratitis o infecciones diseminadas en pacientes neutropénicos.", "fusarium solanii"],
	...
	"J": [
		["Nombre de hongo patógeno oportunista que coloniza el aparato respiratorio, antiguamente considerado parásito.", "pneumocystis jirovecii"],
	...
	"M": [
		...
		["Agente etiológico de otitis media aguda", "moraxella catarrhalis"],
	...
	"P": [
		...
		["Bacilo gram negativo no fermentador", "pseudomonas aeruginosa"],
	...
	"R": [
		["Síndrome caracterizado por la triada: hipoacusia neurosensorial, cardiopatía congénita y anomalías oculares.", "rubeola congenita"],
	...
	"T": [
		["Infección que causa eosinofilia en niños y es transmitida por perros.", "toxocara canis"],
	...
	"X": [
		["Nombre comercial de método diagnóstico molecular para diagnóstico de Mycobacterium tuberculosis, que además identifica resistencia a rifampicina.", "genexpert"]
	],
	"Y": [
